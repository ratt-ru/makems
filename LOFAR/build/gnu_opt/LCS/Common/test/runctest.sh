...
export lofar_sharedir=/home/oms/MakeMS/LOFAR/autoconf_share
export srcdir=/home/oms/MakeMS/LOFAR/LCS/Common/test

# We need to set PYTHONPATH when running python test programs.
export PYTHONPATH=/home/oms/MakeMS/LOFAR/build/gnu_opt/LCS/Common/src:$PYTHONPATH
